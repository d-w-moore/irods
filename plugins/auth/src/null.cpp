#include "irods/plugins/auth/null.hpp"
...
namespace irods
{
    class null_authentication : public irods_auth::authentication_base {
    public:
        null_authentication()
        {
            add_operation(AUTH_ESTABLISH_CONTEXT,    OPERATION(rcComm_t, null_auth_establish_context));
            add_operation(AUTH_CLIENT_AUTH_REQUEST,  OPERATION(rcComm_t, null_auth_client_request));
            add_operation(AUTH_CLIENT_AUTH_RESPONSE, OPERATION(rcComm_t, null_auth_client_response));
#ifdef RODS_SERVER
            add_operation(AUTH_AGENT_START,          OPERATION(rsComm_t, null_auth_agent_start));
            add_operation(AUTH_AGENT_AUTH_REQUEST,   OPERATION(rsComm_t, null_auth_agent_request));
            add_operation(AUTH_AGENT_AUTH_RESPONSE,  OPERATION(rsComm_t, null_auth_agent_response));
            add_operation(AUTH_AGENT_AUTH_VERIFY,    OPERATION(rsComm_t, null_auth_agent_verify));
#endif
        } // ctor
    ...
    private:
        ...
        json null_auth_establish_context(rcComm_t&, const json& req)
        {
            ...
            **/
            ...
            return resp;
        } // null_auth_establish_context

        json null_auth_client_request(rcComm_t& comm, const json& req)
        {
            json svr_req{req};
            ...
            return resp;
        } // null_auth_client_request

        json null_auth_client_response(rcComm_t& comm, const json& req)
        {
            /*
            irods_auth::throw_if_request_message_is_missing_key(
            ...
            */
            ...
            return resp;
        } // null_auth_client_response

#ifdef RODS_SERVER
        json null_auth_agent_request(rsComm_t& comm, const json& req)
        {
            json resp{req};
            ...
            */
            ...
            comm.auth_scheme = strdup(irods_auth::scheme::null);

            return resp;
        } // null_auth_agent_request
        ...
        // not need to support
        json null_auth_agent_verify(rsComm_t&, const json&)
        {
            return {};
        } // null_auth_agent_verify

        // =-=-=-=-=-=-=-
        // stub for ops that the native plug does
        // not need to support
        json null_auth_agent_start(rsComm_t&, const json&)
        {
            return {};
        } // null_auth_agent_start
#endif
    }; // class null_authentication
} // namespace irods

extern "C"
irods::null_authentication* plugin_factory(const std::string&, const std::string&)
{
    return new irods::null_authentication{};
}
